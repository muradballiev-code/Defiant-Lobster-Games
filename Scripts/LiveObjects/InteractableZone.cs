                ...
                switch (_zoneType)
                {
                    case ZoneType.Collectable:
                        if (_itemsCollected == false)
                        {
                            ...
                            if (_displayMessage != null)
                            {
                                ...
                                UIManager.Instance.DisplayInteractableZoneMessage(true, $"Press the {_newZoneKeyInput.ToString()} key to collect");
                        }
                        break;
                    ...
                    case ZoneType.Action:
                        if (_actionPerformed == false)
                        {
                            ...
                            if (_displayMessage != null)
                            {
                                ...
                                UIManager.Instance.DisplayInteractableZoneMessage(true, $"Press the {_newZoneKeyInput.ToString()} key to perform action");
                        }
                        break;
                    ...
                    case ZoneType.HoldAction:
                        ...
                        if (_displayMessage != null)
                        {
                            ...
                            UIManager.Instance.DisplayInteractableZoneMessage(true, $"Hold the {_newZoneKeyInput.ToString()} key to perform action");
                        break;
                }
            }
        }
